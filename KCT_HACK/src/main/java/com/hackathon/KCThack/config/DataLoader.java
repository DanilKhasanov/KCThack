...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadAchievements() {
        ...
        System.out.println(
                "Loaded " + achievements.size() + " achievements"
        );
    }

    private Achievements createAchievement(
            String name,
            String description,
            String icon,
            int pointsRequired
    ...
    private Achievements getAchievementByPoints(
            int points,
            List<Achievements> achievements
    ) {

        return achievements.stream()
                .filter(a -> a.getPointsRequired() <= points)
                .max((a1, a2) ->
                        Integer.compare(
                                a1.getPointsRequired(),
                                a2.getPointsRequired()
                        )
                )
                .orElse(null);
    }
    ...
    private void loadUsers() {
        ...
        if (userRepository.count() > 0) {
            ...
            System.out.println(
                    "Users already exist, skipping generation."
            );
        ...
        User user = createUser(
                ...
                "ivan@example.com",
                "+79123456789",
                "https://t.me/ivan_user",
                "https://github.com/ivan_user",
                ...
                getAchievementByPoints(10, allAchievements)
        );
        ...
        User admin = createUser(
                ...
                "maria@example.com",
                "+79223334455",
                "https://t.me/maria_admin",
                "https://github.com/maria_admin",
                ...
                getAchievementByPoints(50, allAchievements)
        );
        ...
        User judge = createUser(
                ...
                "alex@example.com",
                "+79334445566",
                "https://t.me/alex_judge",
                "https://github.com/alex_judge",
                ...
                getAchievementByPoints(30, allAchievements)
        );
        ...
        User u1 = createUser(
                ...
                getAchievementByPoints(15, allAchievements)
        );
        ...
        User u2 = createUser(
                ...
                "anna@example.com",
                "+79002223344",
                "https://t.me/anna_code",
                "https://github.com/anna_code",
                ...
                getAchievementByPoints(25, allAchievements)
        );
        ...
        User u3 = createUser(
                ...
                "sergey@example.com",
                "+79003334455",
                "https://t.me/sergey_it",
                "https://github.com/sergey_it",
                LocalDate.of(1994, 9, 5),
                userPass,
                "avatar3.png",
                UserRole.USER,
                UserStatus.ACTIVE,
                ...
                getAchievementByPoints(60, allAchievements)
        );
        ...
        User u4 = createUser(
                ...
                "elena@example.com",
                "+79004445566",
                "https://t.me/elena_dev",
                "https://github.com/elena_dev",
                ...
                getAchievementByPoints(35, allAchievements)
        );
        ...
        User u5 = createUser(
                ...
                getAchievementByPoints(70, allAchievements)
        );
    ...
    private void loadSchedules() {
        ...
        if (scheduleRepository.count() > 0) {
            ...
            System.out.println(
                    "Schedules already exist, skipping generation."
            );
        ...
        if (allSkills.isEmpty()) {
            ...
            System.out.println(
                    "No skills in DB, cannot create schedules."
            );

            return;
        }

        Skills javaSkill = findSkillByName(
                allSkills,
                "Java"
        );

        Skills springSkill = findSkillByName(
                allSkills,
                "Spring Boot"
        );

        Skills reactSkill = findSkillByName(
                allSkills,
                "React"
        );

        Skills jsSkill = findSkillByName(
                allSkills,
                "JavaScript"
        );

        Skills pythonSkill = findSkillByName(
                allSkills,
                "Python"
        );
        ...
        hackathon1.setBriefDescription(
                "Хакатон по веб-разработке"
        );

        hackathon1.setDescription(
                "48-часовой хакатон для создания веб-приложений с использованием Java, Spring Boot и React."
        );
        ...
        if (javaSkill != null)
            hackathon1.getSkills().add(javaSkill);

        if (springSkill != null)
            hackathon1.getSkills().add(springSkill);

        if (reactSkill != null)
            hackathon1.getSkills().add(reactSkill);

        ScheduleEntity hackathon2 = new ScheduleEntity();

        hackathon2.setName("AI/ML Хакатон 2026");

        hackathon2.setBriefDescription(
                "Хакатон по искусственному интеллекту"
        );

        hackathon2.setDescription(
                "Соревнование по созданию ML-моделей и анализу данных с использованием Python."
        );
        ...
        hackathon2.setEndDateTime(
                Instant.parse("2026-12-07T20:00:00Z")
        );

        hackathon2.setSkills(new ArrayList<>());

        if (pythonSkill != null)
            hackathon2.getSkills().add(pythonSkill);

        if (jsSkill != null)
            hackathon2.getSkills().add(jsSkill);

        scheduleRepository.saveAll(
                List.of(hackathon1, hackathon2)
        );

        System.out.println("Loaded 2 schedules.");
    }

    private Skills findSkillByName(
            List<Skills> skills,
            String name
    ) {
